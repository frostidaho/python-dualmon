...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/dualmon.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ src/dualmon
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
uninstall: ## uninstall the package - python3
	@echo "----------------------------------------"
	@echo -e "Uninstalling dualmon - may need root\n\t `pip3 --version`"
	@echo "----------------------------------------"
	-pip3 uninstall dualmon

uninstall2: ## uninstall the package - python2
	@echo "----------------------------------------"
	@echo -e "Uninstalling dualmon - may need root\n\t `pip2 --version`"
	@echo "----------------------------------------"
	-pip2 uninstall dualmon
